...
switch (screen){
	...
	case menu_screen.options:
		...
		//draw volume bar
		for(i=0 ; i<num ; i++){
			draw_rectangle( (widthHalf+30)+i*20 ,screen_y+20,(widthHalf+50)+i*20,screen_y+5,false);
		}
		draw_rectangle( (widthHalf+30)+i*20 ,screen_y+20,(widthHalf+50)+9*20,screen_y+5,true);
		//draw volume bar end
